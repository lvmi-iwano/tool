...
enum opt_code
{
  ...
  OPT_mbig_endian = 1041,                    /* -mbig-endian */
  OPT_mbionic = 1042,                        /* -mbionic */
  OPT_mcmodel_ = 1043,                       /* -mcmodel= */
  OPT_mcpu_ = 1044,                          /* -mcpu= */
  ...
  OPT_mstrict_align = 1049,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1050,                  /* -mtls-dialect= */
  OPT_mtune_ = 1051,                         /* -mtune= */
  OPT_muclibc = 1052,                        /* -muclibc */
  OPT_n = 1053,                              /* -n */
  OPT_no_canonical_prefixes = 1054,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1055,              /* -no-integrated-cpp */
  OPT_nocpp = 1056,                          /* -nocpp */
  OPT_nodefaultlibs = 1057,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1058,                   /* -nostartfiles */
  OPT_nostdinc = 1059,                       /* -nostdinc */
  OPT_nostdinc__ = 1060,                     /* -nostdinc++ */
  OPT_nostdlib = 1061,                       /* -nostdlib */
  OPT_o = 1062,                              /* -o */
  OPT_p = 1063,                              /* -p */
  OPT_pass_exit_codes = 1064,                /* -pass-exit-codes */
  /* OPT_pedantic = 1065, */                 /* -pedantic */
  OPT_pedantic_errors = 1066,                /* -pedantic-errors */
  OPT_pg = 1067,                             /* -pg */
  OPT_pie = 1068,                            /* -pie */
  OPT_pipe = 1069,                           /* -pipe */
  OPT_posix = 1070,                          /* -posix */
  OPT_print_file_name_ = 1071,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1072,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1073,          /* -print-multi-directory */
  OPT_print_multi_lib = 1074,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1075,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1076,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1077,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1078,               /* -print-prog-name= */
  OPT_print_search_dirs = 1079,              /* -print-search-dirs */
  OPT_print_sysroot = 1080,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1081,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1082,                        /* -profile */
  OPT_pthread = 1083,                        /* -pthread */
  OPT_quiet = 1084,                          /* -quiet */
  OPT_r = 1085,                              /* -r */
  OPT_rdynamic = 1086,                       /* -rdynamic */
  ...
  OPT_static_libasan = 1097,                 /* -static-libasan */
  OPT_static_libgcc = 1098,                  /* -static-libgcc */
  OPT_static_libgcj = 1099,                  /* -static-libgcj */
  OPT_static_libgfortran = 1100,             /* -static-libgfortran */
  OPT_static_libgo = 1101,                   /* -static-libgo */
  OPT_static_libstdc__ = 1102,               /* -static-libstdc++ */
  OPT_static_libtsan = 1103,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1104, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1105, */                /* -std=c++0x */
  OPT_std_c__11 = 1106,                      /* -std=c++11 */
  OPT_std_c__1y = 1107,                      /* -std=c++1y */
  OPT_std_c__98 = 1108,                      /* -std=c++98 */
  OPT_std_c11 = 1109,                        /* -std=c11 */
  /* OPT_std_c1x = 1110, */                  /* -std=c1x */
  /* OPT_std_c89 = 1111, */                  /* -std=c89 */
  OPT_std_c90 = 1112,                        /* -std=c90 */
  OPT_std_c99 = 1113,                        /* -std=c99 */
  /* OPT_std_c9x = 1114, */                  /* -std=c9x */
  OPT_std_f2003 = 1115,                      /* -std=f2003 */
  OPT_std_f2008 = 1116,                      /* -std=f2008 */
  OPT_std_f2008ts = 1117,                    /* -std=f2008ts */
  OPT_std_f95 = 1118,                        /* -std=f95 */
  OPT_std_gnu = 1119,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1120, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1121, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1122,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1123,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1124,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1125,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1126, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1127, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1128,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1129,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1130, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1131, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1132,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1133, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1134, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1135, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1136,                     /* -std=legacy */
  OPT_symbolic = 1137,                       /* -symbolic */
  OPT_t = 1138,                              /* -t */
  OPT_time = 1139,                           /* -time */
  OPT_time_ = 1140,                          /* -time= */
  OPT_tno_android_cc = 1141,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1142,                 /* -tno-android-ld */
  OPT_traditional = 1143,                    /* -traditional */
  OPT_traditional_cpp = 1144,                /* -traditional-cpp */
  OPT_trigraphs = 1145,                      /* -trigraphs */
  OPT_u = 1146,                              /* -u */
  OPT_undef = 1147,                          /* -undef */
  OPT_v = 1148,                              /* -v */
  OPT_version = 1149,                        /* -version */
  OPT_w = 1150,                              /* -w */
  OPT_wrapper = 1151,                        /* -wrapper */
  OPT_x = 1152,                              /* -x */
  OPT_z = 1153,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
