...
// +5v
#define __HCT_GPIO_LCM_POWER_ENN_PINMUX__   PINMUX_GPIO25__FUNC_GPIO25
// -5v
#define __HCT_GPIO_LCM_POWER_ENP_PINMUX__   PINMUX_GPIO26__FUNC_GPIO26
//1.8v ldo
...
#define __HCT_GPIO_FLASHLIGHT_EN_PIN__			PINMUX_GPIO8__FUNC_GPIO8
/*flashlight pwm pin*/
#if __HCT_FLASHLIGHT_SGM3785_SUPPORT__

#define __HCT_GPIO_FLASHLIGHT_PWM_AS_PWM_PIN__		PINMUX_GPIO9__FUNC_PWM_B
#define __HCT_GPIO_FLASHLIGHT_PWM_AS_GPIO_PIN__		PINMUX_GPIO9__FUNC_GPIO9
#define __HCT_FLASHLIGHT_PWM_NUM__                      2

#endif

#if __HCT_FLASHLIGHT_AW3641_SUPPORT__||__HCT_FLASHLIGHT_AW3141_SUPPORT__
#define __HCT_GPIO_FLASHLIGHT_MODE_PINMUX__			PINMUX_GPIO9__FUNC_GPIO9
#endif
/*flashlight sub en*/

#if __HCT_SUB_FLASHLIGHT_SUPPORT__
#define __HCT_GPIO_FLASHLIGHT_SUB_EN_PIN__		PINMUX_GPIO12__FUNC_GPIO12
#endif
#if  __HCT_SUB_FLASHLIGHT_SGM3785_SUPPORT__
#define  __HCT_SUB_FLASHLIGHT_PWM_NUM__			12
#define  __HCT_GPIO_FLASHLIGHT_SUB_PWM_AS_PWM_PIN__    PINMUX_GPIO12__FUNC_PWM_C
#define  __HCT_GPIO_FLASHLIGHT_SUB_PWM_AS_GPIO_PIN__    PINMUX_GPIO12__FUNC_GPIO12

#endif
/**************************Audio EXMP Related*********/
/** No use,and move to hct_board_config.h __HCT_EXTAMP_GPIO_NUM__  **/
...
#define __HCT_AW9136_TS_I2C_BUS_NUM__	3
#define __HCT_AW9136_TS_ADDR__			0x2C
#define __HCT_CTP_AW9136_INT_NUM__		11
#define __HCT_AW9136_INT_PINNUX__		PINMUX_GPIO11__FUNC_GPIO11

#define __HCT_GPIO_AW9136_PDN_PINMUX__		PINMUX_GPIO5__FUNC_GPIO5
#endif

/**************************RGB GPIO Related****************/
#if __HCT_GREEN_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__
#define  __HCT_GPIO_RGB_GREEN_EN_PIN__ 		PINMUX_GPIO12__FUNC_GPIO12
#endif

#if __HCT_BUTTON_BACKLIGHT_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__
#define  __HCT_GPIO_KPDLED_EN_PIN__ 		PINMUX_GPIO5__FUNC_GPIO5
#endif
...
#define __HCT__BMI160_ACC_SENSOR_DIRECTION__		3
...
#define __HCT__BMI160_GYRO_SENSOR_DIRECTION__		3
#endif
...
/*Step1: define this macro*/
/*Step2: need define dws int tab with the right bus num*/
#define __HCT_SWITCH_CHARGER_I2C_BUS_NUM__       1
...
/*EINT*/
#define __HCT_TYPEC_EINT_PIN_NUM__					82
#define __HCT_TYPEC_EINT_PIN__          			PINMUX_GPIO82__FUNC_GPIO82
/*USB ID as EINT*/
...
/**************************USB OTG Related****************/
	...
	#define __HCT_GPIO_DRV_VBUS_PIN__     			PINMUX_GPIO43__FUNC_GPIO43
