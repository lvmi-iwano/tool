...
comp-cflags = -fno-builtin
comp-aflags =
comp-cppflags =

comp-cflags  	+= -fdiagnostics-show-option
comp-cflags  	+= -fno-omit-frame-pointer 
...
comp-cflags	+= $(comp-cflags-warns-$(WARNS))

comp-cxxflags-incompatible := -Wmissing-prototypes -Wnested-externs \
	-Wstrict-prototypes -Wold-style-definition -Wdeclaration-after-statement
comp-cxxflags += -fno-exceptions -fno-rtti
...
comp-flags-$2 = $$(filter-out $$(CFLAGS_REMOVE) $$(cflags-remove) \
		   ...
		   $$(CFLAGS) $$(CFLAGS_WARNS) \
		   $$(comp-cflags) $$(cflags) \
		   $$(cflags-lib$$(comp-lib-$2)) $$(cflags-$2)) -std=gnu99
ifeq ($C,1)
...
comp-q-$2 := CXX
comp-cxxflags-$2 = $$(filter-out $$(CXXFLAGS_REMOVE) $$(cxxflags-remove) \
			      $$(cxxflags-remove-$2), \
		   $$(CXXFLAGS) $$(CXXFLAGS_WARNS) \
		   $$(comp-cxxflags) $$(cxxflags) \
		   $$(cxxflags-lib$$(comp-lib-$2)) $$(cxxflags-$2))
comp-cflags-$2 = $$(filter-out $$(CFLAGS_REMOVE) $$(cflags-remove) \
			      $$(cflags-remove-$2), \
		   $$(CFLAGS) $$(CFLAGS_WARNS) \
		   $$(comp-cflags) $$(cflags) \
		   $$(cflags-lib$$(comp-lib-$2)) $$(cflags-$2))
_comp-flags-$2 = $$(comp-cflags-$2)
_comp-flags-$2 += $$(comp-cxxflags-$2)
comp-flags-$2 = $$(filter-out $$(comp-cxxflags-incompatible), $$(_comp-flags-$2))
comp-cmd-$2 = $$(CXX) $$(comp-flags-$2) -c $$< -o $$@
