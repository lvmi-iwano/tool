...
struct gfx1xm_dev {
	...
	//ether add sheep 20160526 begin
	struct notifier_block notifier;
	char fb_black;
	//ether add sheep 20160526 end
};
...
//ether add sleep begin 20160504
#define  GF_IOC_PM_FBCABCK   _IO(GFX1XM_IOC_MAGIC, 10)
//ether add sleep end 20160504
...
inline static long spi_dts_gpio_init(struct  gfx1xm_dev *pdev)
{
	...
	node = of_find_compatible_node(NULL, NULL,"mediatek,mt6755-finger");
	#if 1
	if(node){
